...
- 本模组是为 MirageV Q.A.E.C.(MC Forge)服务器专门开发，但代码完全开源，可自由使用，但必须遵守许可证。
...
>*Some assets are sourced from publicly available resources on the internet.*
>*All rights belong to their respective owners.*
>
> *部分资源素材来源于互联网公开可获取的资源。*
> *所有权利归各自所有者所有。*
